...
async def main(location, search_query, num_pages, target_leads):
    """
    ...
    Args:
        ...
        target_leads (int): Maximum number of leads to save
    """
    ...
    save_places_to_excel(places_data, excel_filename, limit=target_leads)
...
if __name__ == "__main__":
    ...
    num_pages = max(1, (target_leads + 19) // 20)
    
    # Run main function
    asyncio.run(main(location, search_query, num_pages, target_leads))
